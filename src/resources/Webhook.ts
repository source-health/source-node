...
export interface Webhook {
     ...
     */
    events: Array<"account.updated" | "care_team.created" | "care_team.updated" | "care_team.deleted" | "device.created" | "device.activated" | "device.deactivated" | "device.deleted" | "file.created" | "measurement.created" | "order.created" | "order.shipped" | "member.created" | "member.updated" | "member.deleted" | "message.created" | "task.created" | "task.updated" | "task_definition.created" | "task_definition.updated" | "thread.created" | "thread.updated" | "webhook.created" | "webhook.updated" | "webhook.deleted">;
    /**
...
export class WebhookResource extends Resource {
     ...
     * webhook.
     */
    public update(id: string, params?: WebhookUpdateParams, options?: SourceOptions): Promise<Webhook> {
